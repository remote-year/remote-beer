...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { city_id: @beer.city_id, name: @beer.name, rating: @beer.rating, style: @beer.style } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { city_id: @beer.city_id, name: @beer.name, rating: @beer.rating, style: @beer.style } }
